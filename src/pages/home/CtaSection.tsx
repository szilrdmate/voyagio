	...
	return (
		<div className="border border-t-gray-300 bg-white px-6 pb-28 pt-16">
			<div className="mx-auto flex h-96 max-w-6xl flex-col items-center justify-evenly rounded-3xl bg-gradient-to-br from-sky-500 to-indigo-500 text-white">
				...
				<button onClick={goPlan} className="rounded-2xl bg-gradient-to-b from-sky-400 to-sky-500 px-8 py-4 text-3xl font-semibold shadow-lg transition-transform duration-150 ease-in-out hover:scale-[1.02]">
					Experience it now
				</button>
			</div>
		</div>
