...
const About: React.FC = () => {
	...
	const about = [
		{
			...
			src: "https://img.pikbest.com/element_our/20230728/bg/7e9ec9bf5a3bc.png!sw800",
			cta: "Get Planning",
			bg: "bg-blue-500",
		},
		{
		...
		},
		{
			...
			src: "https://cdn3d.iconscout.com/3d/premium/thumb/passport-5796872-4841625.png",
	...
	return (
		<div style={{ backgroundImage: "linear-gradient(to top, rgba(0,0,0,0.1), rgba(245,245,245,0.5),rgba(0,0,0,0)), url('https://img.freepik.com/premium-vector/vector-white-abstract-futuristic-background-with-perspective-infinity-grid-tile-floor-texture_547648-3196.jpg')" }} className="w-full bg-cover px-6 pb-40 pt-16">
				...
				{about.map((item, id) => (
					<div key={id} className="mb-8 flex flex-col justify-between gap-8 lg:flex-row">
						...
						<div className="mx-auto max-w-xl rounded-3xl  bg-white px-8 py-10 shadow-lg backdrop-blur-xl">
							...
							<button onClick={handleNaviagtion} className={`${item.bg} w-full rounded-xl px-6 py-4 text-center text-xl font-semibold text-white shadow-md`}>
								{item.cta}
							</button>
						</div>
					</div>
