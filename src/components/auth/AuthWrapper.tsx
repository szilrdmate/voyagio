...
const AuthWrapper: React.FC = () => {
	...
	const signTranslateClass = intermediateSignIn ? "-translate-x-0" : "translate-x-full";

	return (
		<div className="flex h-screen w-full items-center justify-center bg-gradient-to-b from-blue-700 via-blue-500 to-white px-6">
			<div className="relative grid grid-cols-2 overflow-hidden rounded-3xl bg-white shadow-lg">
				<div className={`absolute z-10 h-full w-1/2 bg-white transition-transform delay-75 duration-300 ease-in-out ${translateClass}`}>
