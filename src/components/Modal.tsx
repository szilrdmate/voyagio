...
const Modal: React.FC<ModalProps> = ({ post, onClose }) => {
  ...
  return (
    <div className=' px-4 fixed z-50 inset-0 overflow-hidden grid place-content-center w-screen h-screen'>
      ...
      {/* Modal content */}
      <div className='border border-gray-300 z-10 max-w-2xl mx-auto bg-white rounded-3xl text-left overflow-x-hidden shadow-xl h-[80vh] overflow-y-scroll no-scrollbar relative'>
