  ...
  return (
    <div className='w-full flex pt-40 pb-28 justify-center items-center bg-gradient-to-br from-blue-700 via-purple-800 via-teal-600 to-purple-700 border-b-2 border-gray-300'>
      <div className='max-w-3xl'>
        <h1 className='text-7xl font-bold mb-2 leading-normal text-center'>
        ...
        <Link to='/planner'>
          <div className='hover:scale-[1.02] duration-300 transition-transform flex justify-center items-center button bg-blue-400 w-full h-20 text-3xl'>
