	...
	return (
		<div className="w-full bg-white px-4 sm:px-6">
			<div className="mx-auto max-w-6xl pt-16">
				<h2 className="mb-8 text-5xl font-extrabold text-gray-800">Featured Locations</h2>
				<div ref={containerRef} className="no-scrollbar mx-auto flex max-w-5xl snap-x snap-mandatory overflow-x-auto pb-16">
